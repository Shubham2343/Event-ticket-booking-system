...
const linkColumns = [
  ...
  },
  {
    ...
    links: [
      ...
      { label: 'Contact Us', href: 'mailto:support@ticketflow.com' },
      ...
      <div className="container footer-top">
        ...
        <div className="footer-brand-col">
          ...
          <p className="footer-tagline">
            Your gateway to unforgettable live events. Reserve your perfect seat
            in seconds — anywhere, anytime.
          </p>

          <form className="footer-newsletter" onSubmit={handleSubscribe}>
            <label className="footer-news-label">Get event updates</label>
            <div className="footer-news-row">
              <input
                ...
                required
              />
              <button type="submit" className="footer-news-btn">Subscribe</button>
            </div>
            {subscribed && <span className="footer-news-success">✓ You're subscribed!</span>}
          </form>
        </div>
